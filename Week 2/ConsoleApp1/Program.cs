...
namespace App1.cs
{
    internal class Program
    {
        ...
        static void managerInterface(Manager manager)
        {
            header();
            ...
            while (managerOption != "7")
            {
                if (checkMmenu(managerOption))
                {
                    ...
                    {
                        header();
                        string newroomNumber, newroomtype;
                        float newprice;
                        ...
                        manager.AddRoom(newroomNumber, newroomtype, newprice);
                        Console.ForegroundColor = ConsoleColor.Green;
                    ...
                    else if (managerOption == "4")
                    {
                        ...
                        Console.Write($"    Enter new Price of Room Number {roomNumber}: ");
                        newPrice = float.Parse(Console.ReadLine());

                        manager.UpdateRoom(roomNumber, newType, newPrice);
                        Console.ForegroundColor = ConsoleColor.Green;
                        Console.WriteLine("    Press any key to continue to Manager Menu....");
                        clearscreen();
                        managerOption = ManagerMenu();
                    ...
                    {
                        // Update Hotel Details (to be implemented)
                        Console.ForegroundColor = ConsoleColor.Green;
                        Console.WriteLine("    Press any key to continue to Manager Menu....");
                        clearscreen();
                        managerOption = ManagerMenu();
                    ...
                    {
                        // Review Guest Feedback (to be implemented)
                        Console.ForegroundColor = ConsoleColor.Green;
                        Console.WriteLine("    Press any key to continue to Manager Menu....");
                        clearscreen();
                        managerOption = ManagerMenu();
